...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "1660feaf2f381826a6b9";
...
function (_DiaModal) {
  ...
  function DiaModalForm(_ref) {
    ...
    var _ref$template = _ref.template,
        template = _ref$template === void 0 ? __webpack_require__(/*! ../templates/diamodal.art */ "./src/templates/diamodal.art") : _ref$template,
        _ref$formTemplate = _ref.formTemplate,
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DiaModalForm).call(this, {
      template: template,
      title: title,
      content: formHTML
    }));
...
Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_1__["ready"])(function () {
...
/*!******************************!*\
  !*** ./src/utils/helpers.js ***!
  \******************************/
/*! exports provided: generateUID, createElementFromHTML, addClass, removeClass, ready */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
