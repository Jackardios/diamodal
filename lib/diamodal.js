...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "36c6996b2d6aea5e668f";
  ...
  _createClass(DiaModal, [{
    ...
    value: function _attachHandlers() {
      ...
      if (this._triggerBtnSelector) {
        Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_0__["addDelegatedEventListener"])(document, 'click', this._triggerBtnSelector, function () {
          _this2.open();
        });
      }
    }
    ...
    value: function compile() {
      ...
      var transitionDuration = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this._transitionDuration;
...
function (_DiaModal) {
  ...
  function DiaModalForm(_ref) {
    ...
    var _ref$formTemplate = _ref.formTemplate,
        ...
        _ref$enctype = _ref.enctype,
        enctype = _ref$enctype === void 0 ? "" : _ref$enctype,
      ...
      return f;
        ...
        otherOptions = _objectWithoutProperties(_ref, ["formTemplate", "action", "method", "enctype", "attributes", "inputs", "submitText", "onSubmit"]);
...
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/helpers */ "./src/utils/helpers.js");
/* harmony import */ var _components_DiaModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/DiaModal */ "./src/components/DiaModal.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DiaModal", function() { return _components_DiaModal__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _components_DiaModalForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/DiaModalForm */ "./src/components/DiaModalForm.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DiaModalForm", function() { return _components_DiaModalForm__WEBPACK_IMPORTED_MODULE_4__["default"]; });
...
function appendScrollbarCompensateStyleToHead(isMobile) {
  if (!isMobile) {
    ...
    var css = ".diamodal-scrollbar-compensate{margin-right:".concat(scrollbarWidth, "px;}");
...
Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_2__["ready"])(function () {
...
module.exports = function ($data) {
    ...
    $$out += '<form action="';
    $$out += $escape($data.action || '');
    $$out += '"\n      method="';
    $$out += $escape($data.method || '');
    $$out += '"\n      enctype="';
    $$out += $escape($data.enctype || '');
    $$out += '"\n      class="diamodal-form"\n      data-diamodal-form\n      ';
    if ($data.attributes) {
        $$out += '\n        ';
    ...
    if ($data.inputs) {
        ...
        $each($data.inputs, function (input, index) {
            $$out += '\n      ';
            if (input.type) {
                $$out += '\n        <div class="diamodal-form-input diamodal-form-input--fullwidth diamodal-form-input--';
    ...
    $$out += '\n  <button type="submit" class="diamodal-form__submit-button" data-diamodal-form-submit>';
...
module.exports = function ($data) {
    ...
    $$out += '<div class="diamodal diamodal--is-close" role="dialog" tabindex="-1"\n     style="-webkit-transition-duration: ';
    $$out += $escape($data.transitionDuration);
    $$out += 'ms;\n                 -o-transition-duration: ';
    $$out += $escape($data.transitionDuration);
    $$out += 'ms;\n                    transition-duration: ';
    $$out += $escape($data.transitionDuration);
    $$out += 'ms;">\n  <div class="diamodal__container"><div class="diamodal-box diamodal-box--';
    $$out += $escape($data.boxSize);
    $$out += '">\n      <div class="diamodal-box__header">\n        <div class="diamodal-box__title">';
    $$out += $data.title;
    $$out += '</div>\n        <button class="diamodal-box__close-button" data-diamodal-close>\n          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.642 15.642" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 15.642 15.642">\n            <path fill-rule="evenodd" d="M8.882,7.821l6.541-6.541c0.293-0.293,0.293-0.768,0-1.061  c-0.293-0.293-0.768-0.293-1.061,0L7.821,6.76L1.28,0.22c-0.293-0.293-0.768-0.293-1.061,0c-0.293,0.293-0.293,0.768,0,1.061  l6.541,6.541L0.22,14.362c-0.293,0.293-0.293,0.768,0,1.061c0.147,0.146,0.338,0.22,0.53,0.22s0.384-0.073,0.53-0.22l6.541-6.541  l6.541,6.541c0.147,0.146,0.338,0.22,0.53,0.22c0.192,0,0.384-0.073,0.53-0.22c0.293-0.293,0.293-0.768,0-1.061L8.882,7.821z"/>\n          </svg>\n        </button>\n      </div>\n      <div class="diamodal-box__content">';
    $$out += $data.content;
    $$out += '</div>\n    </div>\n  </div>\n</div>';
    return $$out;
};
