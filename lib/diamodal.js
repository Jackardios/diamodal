...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "367950818689c6465319";
...
function (_DiaModal) {
  ...
  function DiaModalForm(_ref) {
    ...
    var _ref$formTemplate = _ref.formTemplate,
        ...
        addRequiredLabel = _ref$addRequiredLabel === void 0 ? false : _ref$addRequiredLabel,
      ...
      return f;
        ...
        otherOptions = _objectWithoutProperties(_ref, ["formTemplate", "action", "method", "enctype", "attributes", "inputs", "submitText", "submitButtomClass", "addRequiredLabel", "requiredLabelText", "onSubmit"]);
...
module.exports = function ($data) {
    ...
    $$out += '" class="diamodal-form" data-diamodal-form ';
    if ($data.attributes) {
        $$out += ' ';
...
module.exports = function ($data) {
    ...
    $$out += $escape($data.transitionDuration);
    $$out += 'ms"><div class="diamodal__container"><div class="diamodal-box diamodal-box--';
